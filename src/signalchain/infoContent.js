...
export const PANEL_INFO = {
  ...
  limiter: {
    ...
    params: [
      ...
      { name: 'Style', desc: 'The limiting character: Transparent (clean), Punchy (shorter release for energy), Modern (very fast, loud), Warm (soft knee + slower release) and Classical (long release that preserves dynamics).' },
